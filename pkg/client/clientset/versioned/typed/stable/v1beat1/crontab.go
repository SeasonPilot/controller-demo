...
import (
	...
	scheme "github.com/SeasonPilot/controller-demo/pkg/client/clientset/versioned/scheme"
...
type CronTabInterface interface {
	Create(*v1beat1.CronTab) (*v1beat1.CronTab, error)
	Update(*v1beat1.CronTab) (*v1beat1.CronTab, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1beat1.CronTab, error)
	List(opts v1.ListOptions) (*v1beat1.CronTabList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1beat1.CronTab, err error)
	CronTabExpansion
}
...
func newCronTabs(c *StableV1beat1Client, namespace string) *cronTabs {
	return &cronTabs{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *cronTabs) Get(name string, options v1.GetOptions) (result *v1beat1.CronTab, err error) {
	result = &v1beat1.CronTab{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("crontabs").
		Name(name).
...
func (c *cronTabs) List(opts v1.ListOptions) (result *v1beat1.CronTabList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1beat1.CronTabList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("crontabs").
...
func (c *cronTabs) Create(cronTab *v1beat1.CronTab) (result *v1beat1.CronTab, err error) {
	result = &v1beat1.CronTab{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("crontabs").
...
func (c *cronTabs) Update(cronTab *v1beat1.CronTab) (result *v1beat1.CronTab, err error) {
	result = &v1beat1.CronTab{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("crontabs").
...
func (c *cronTabs) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1beat1.CronTab, err error) {
	result = &v1beat1.CronTab{}
